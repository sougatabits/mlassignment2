...
def load_and_preprocess_data(filepath="data/weatherAUS.csv"):
    ...
    cols_to_drop = ["Cloud9am", "Cloud3pm", "MinTemp", "MaxTemp", "Humidity9am", "Humidity3pm"]
...
def train_and_save_models():
    ...
    results_df.to_csv("assignment2matrix.csv", index=False)
    print("Training completed! Metrics saved to assignment2matrix.csv")
    print(results_df)
