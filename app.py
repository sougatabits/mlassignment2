...
st.dataframe(input_df)
 ...
 ed by: Sougata Das BITSID:2024DC04257")
...
def user_input_features():
    feature_values = {}
    # Only essential features for user input
    essential_features = ["Location","MinTemp", "MaxTemp", "RainToday", "Humidity3pm"]

    for feature in essential_features:
        feature_values[feature] = st.sidebar.number_input(feature, value=0.0)
